...
#include "RenderingBackend/Core/Types.h"
...
{
	FilterMode		   filter;			// Default: "FilterMode::MIN_MAG_MIP_LINEAR"
	TextureAddressMode addressU;		// (also known as "S"), Default: "TextureAddressMode::CLAMP"
	TextureAddressMode addressV;		// (also known as "T"), Default: "TextureAddressMode::CLAMP"
	TextureAddressMode addressW;		// (also known as "R"), Default: "TextureAddressMode::CLAMP"
	float			   mipLodBias;		// Default: "0.0f"
	uint32_t		   maxAnisotropy;	// Default: "16"
	ComparisonFunc	   comparisonFunc;	// Default: "ComparisonFunc::NEVER"
