...
struct IndirectBufferFlag final
{
	enum Enum
	{
		...
		DRAW_ARGUMENTS = 1 << 2,	// This indirect buffer contains "DrawArguments" as elements, if "IndirectBufferFlag::DRAW_ARGUMENTS" is set it's invalid to have "IndirectBufferFlag::DRAW_INDEXED_ARGUMENTS" set as well
		DRAW_INDEXED_ARGUMENTS = 1 << 3		// This indirect buffer contains "DrawIndexedArguments" as elements, if "IndirectBufferFlag::DRAW_ARGUMENTS" is set it's invalid to have "IndirectBufferFlag::DRAW_INDEXED_ARGUMENTS" set as well
	};
};
