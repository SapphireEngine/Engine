...
Path* ZipFileSystem::CopyPathInParent() const
{
	return fsCopyPath(pPathInParent);
}
...
char ZipFileSystem::GetPathDirectorySeparator() const
{
	return '/';
}

size_t ZipFileSystem::GetRootPathLength() const
{
	return 0;
}
...
time_t ZipFileSystem::GetCreationTime(const Path* filePath) const
{
	return mCreationTime;
}

time_t ZipFileSystem::GetLastAccessedTime(const Path* filePath) const
{
