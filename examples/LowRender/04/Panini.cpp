...
void createTessellatedQuadBuffers(
	Renderer* pRenderer, se::Buffer** ppVertexBuffer, se::Buffer** ppIndexBuffer, unsigned tessellationX, unsigned tessellationY)
{
...
void Panini::SetSourceTexture(se::Texture* pTex, uint32_t index)
{
	ASSERT(pTex);
